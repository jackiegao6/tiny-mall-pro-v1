...
CREATE TABLE `pay_order` (
                             ...
                             `deduction_price` decimal(8,2) DEFAULT NULL COMMENT '营销金额；优惠金额',
                             `current_price` decimal(8,2) NOT NULL COMMENT '支付金额',
...
INSERT INTO `pay_order` (`id`, `user_id`, `product_id`, `product_name`, `order_id`, `order_time`, `total_amount`, `status`, `pay_url`, `pay_time`, `market_type`, `deduction_price`, `current_price`, `create_time`, `update_time`)
VALUES
